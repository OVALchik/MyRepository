...
namespace OOPlaba2
{
    ...
    {    /*  
                ...
                case 1:
                    {
                       ...
                       {
                          new PrimaryProduction(TypeMaterial.Wood, TypeProduction.Plate,"Лист W-4",new Size( 50, 70, 5, 3), 10000),
                          new PrimaryProduction(TypeMaterial.Wood, TypeProduction.Rod,"Прут W-5",new Size( 0.5, 0.5, 5, 7), 5000)
                       };
                ...
                case 2:
                    {
                        ...
                        {
                            new SecondaryProduction("Заготовка-I5",new Size( 50, 50, 12, 5), TypeMaterial.Iron),
                            new SecondaryProduction("Заготовка-P3",new Size( 150, 50, 7, 40),TypeMaterial.Titanium)
                        };
        ...
        public static void ShowInfoReport(Industry industry)
        {
            ...
            Console.WriteLine("6.Просмотр информации об автоматизированных системах");
